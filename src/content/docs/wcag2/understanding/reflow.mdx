...
<figure id="figure-CSS-pixel-letter-4x">
    <img src="/docs/img/css-pixel-by-device.png" width="462" height="198" alt="작은 화면 장치는 가까이 있고, 큰 화면 장치는 멀리 있을 때 망막에 동일한 이미지를 만들기 위해 보는 거리에 따라 필요한 문자 크기를 보여주는 다이어그램" />
