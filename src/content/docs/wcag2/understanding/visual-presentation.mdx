---
title: 1.4.8 시각적 표현
description: WCAG 2.2 이해 성공 기준 1.4.8 시각적 표현
head:
    - tag: title
      content: 성공 기준 이해 1.4.8 시각적 표현
tableOfContents:
    maxHeadingLevel: 4
...
<dl>
<dt>목표</dt>
<dd>텍스트 모양을 사용자가 기본 설정에 맞게 변경할 수 있다.</dd>
<dt>할 일</dt>
<dd>텍스트 표시 요구 사항을 충족하거나 사용자가 이를 조정할 수 있도록 허용한다.</dd>
<dt>중요성</dt>
<dd>일부 텍스트 형식은 인지 장애가 있거나 시력이 약한 사용자가 더 쉽게 읽을 수 있다.</dd>
</dl>
...
<figure class="understanding-figure" id="figure-text-cut">
    <figcaption>그림 1 다음 이미지는 단락의 단일 간격, 절반 간격 및 이중 간격 텍스트의 예를 보여준다.</figcaption>
    <img src="/docs/img/wcag22understanding/single-space.gif" alt="단일 간격 텍스트의 예. (텍스트의 각 줄 사이에 공백이 없음)" style="display:inline-block" />
    <img src="/docs/img/wcag22understanding/space-and-a-half.gif" alt="절반 간격(space-and-a-half) 텍스트의 예. (텍스트 줄 높이의 절반에 해당하는 공백)" style="display:inline-block;margin: 0 4px;" />
    <img src="/docs/img/wcag22understanding/double-space.gif" alt="이중 간격 텍스트의 예. (각 줄 사이의 텍스트 줄 높이와 동일한 공백)" style="display:inline-block" />
</figure>
