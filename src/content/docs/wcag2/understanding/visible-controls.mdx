---
title: 이해 3.2.7 Visible Controls- Korean Translation Version(Unofficial)
description: WCAG 2.2 이해 성공 기준 3.2.7 Visible Controls- Korean Translation Version(Unofficial)
head:
    - tag: title
      content: 성공 기준 이해 3.2.7 Visible Controls- Korean Translation Version(Unofficial)
tableOfContents:
    maxHeadingLevel: 4
