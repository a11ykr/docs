...
웹 콘텐츠 접근성 지침(WCAG)은 장애인이 웹사이트, 애플리케이션 및 기타 디지털 콘텐츠에 접근할 수 있도록 하기 위한 요구 사항을 제공한다. WCAG 소개, 지원 기술 문서 및 교육 자료는 [WCAG 2 개요](https://www.w3.org/WAI/standards-guidelines/wcag/)를 참고하라.
