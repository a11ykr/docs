---
title: 2.5.6         동시 입력 매커니즘
description: WCAG 2.2 이해 성공 기준 2.5.6 동시 입력 매커니즘
head:
    - tag: title
      content: 성공 기준 이해 2.5.6 동시 입력 매커니즘
tableOfContents:
    maxHeadingLevel: 4
...
## [성공기준 이해 2.5.6](https://w3.org/TR/WCAG22#concurrent-input-mechanisms):동시 입력 매커니즘 
