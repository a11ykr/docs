...
## [성공기준 이해 1.4.12](https://w3.org/TR/WCAG22#text-spacing):텍스트 간격 
...
![제목 텍스트가 세로로 잘렸다.](/docs/assets/img/spacing_cutoff_fail_vertical.png)
...
![잘린 텍스트가 있는 3개의 제목이 나란히 표시된다.](/docs/assets/img/spacing_cutoff_fail_horizontal.png)
...
![제목 텍스트가 단락 텍스트의 일부와 겹친다.](/docs/assets/img/spacing_overlap_fail.png)
