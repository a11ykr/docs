...
![제목 텍스트가 세로로 잘렸다.](/assets/img/spacing_cutoff_fail_vertical.png)
...
![잘린 텍스트가 있는 3개의 제목이 나란히 표시된다.](/assets/img/spacing_cutoff_fail_horizontal.png)
...
![제목 텍스트가 단락 텍스트의 일부와 겹친다.](/assets/img/spacing_overlap_fail.png)
