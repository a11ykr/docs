...
## [성공기준 이해 1.4.12](https://w3.org/TR/WCAG22#text-spacing):텍스트 간격 (Level AA)
...
*   [Important letter spacing in style attributes is wide enough](/WAI/standards-guidelines/act/rules/24afc2/)
*   [Important line height in style attributes is wide enough](/WAI/standards-guidelines/act/rules/78fd32/)
*   [Important word spacing in style attributes is wide enough](/WAI/standards-guidelines/act/rules/9e45ec/)
