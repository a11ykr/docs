...
## [성공기준 이해 1.4.5](https://w3.org/TR/WCAG22#images-of-text):텍스트 이미지 

(Level AA)

<Card title="성공 기준 (SC)"></Card>

사용되는 기술이 표현(presentation)을 할 수 있는 경우라 하더라도, 정보는 [텍스트 이미지](../../../glossary/image-of-text)보다 [텍스트](../../../glossary/text)로 전달해야 한다. 단, 다음의 경우는 제외한다.
...
참조하라 [1.4.9: 텍스트 이미지 (예외 없음)](images-of-text-no-exception).
