---
title: 성공 기준 1.3.1 정보와 관계
description: 성공 기준 이해 1.3.1 정보와 관계
---

import { Aside, Badge, Card } from '@astrojs/starlight/components';

## [성공기준 이해 1.3.1](https://w3.org/TR/WCAG22#info-and-relationships):정보와 관계 (Level A)
...
*   [ARIA required context role](/WAI/standards-guidelines/act/rules/ff89c9/proposed/)
*   [ARIA required ID references exist](/WAI/standards-guidelines/act/rules/in6db8/proposed/)
*   [ARIA required owned elements](/WAI/standards-guidelines/act/rules/bc4a75/proposed/)
...
*   [Table header cell has assigned cells](/WAI/standards-guidelines/act/rules/d0f69e/proposed/)
