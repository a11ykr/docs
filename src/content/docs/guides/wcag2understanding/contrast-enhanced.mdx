---
title: 성공 기준 1.4.6 명도 대비 (향상된)
description: 성공 기준 이해 1.4.6 명도 대비 (향상된)
tableOfContents:
    maxHeadingLevel: 4
---
...
## [성공기준 이해 1.4.6](https://w3.org/TR/WCAG22#contrast-enhanced):명도 대비 (향상된) 
...
![대비되지 않는 회색 텍스트가 있는 회색 버튼입니다.](/docs/assets/img/inactive-button.png)
