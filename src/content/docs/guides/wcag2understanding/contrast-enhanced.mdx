...
## [성공기준 이해 1.4.6](https://w3.org/TR/WCAG22#contrast-enhanced):명도 대비 (향상된) (Level AAA)
...
어떤 사람들은 최소한의 대비로는 텍스트를 읽을 수 없다.
...
*   [Text has minimum contrast](/WAI/standards-guidelines/act/rules/afw4f7/)
