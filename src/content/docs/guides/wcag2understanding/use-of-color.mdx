---
title: 성공 기준 1.4.1 색상 사용
description: 성공 기준 이해 1.4.1 색상 사용
tableOfContents:
    maxHeadingLevel: 4
---
...
## [성공기준 이해 1.4.1](https://w3.org/TR/WCAG22#use-of-color):색상 사용 
...
이 성공기준은 색상 인식을 구체적으로 다루고 있다. 다른 형태의 인식은 색상 및 다른 표현(presentation) 코딩에 대한 프로그래밍 방식의 접근을 포함하고 있는 [지침 1.3 적응 가능성](https://www.w3.org/TR/WCAG22/#adaptable)에서 다루고 있다.
