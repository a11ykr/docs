...
## [성공기준 이해 1.3.2](https://w3.org/TR/WCAG22#meaningful-sequence):의미있는 순서 (Level A)
...
내용의 순서를 더 많은 사람들이 이해할 수 있습니다.

할 일

코드를 이용해 의미 있는 콘텐츠 순서를 유지하라.

중요성

보조 기술은 사용자에게 적절한 순서로 콘텐츠를 제공할 수 있다.
