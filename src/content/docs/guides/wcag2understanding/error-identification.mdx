...
## [성공기준 이해 3.3.1](https://w3.org/TR/WCAG22#error-identification):오류 식별 (Level A)
...
*   [Error message describes invalid form field value](/WAI/standards-guidelines/act/rules/36b590/proposed/)
