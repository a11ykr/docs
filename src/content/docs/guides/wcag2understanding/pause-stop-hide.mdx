...
## [성공기준 이해 2.2.2](https://w3.org/TR/WCAG22#pause-stop-hide):일시정지, 중지, 숨김 (Level A)
...
*   [Text content that changes automatically can be paused, stopped or hidden](/WAI/standards-guidelines/act/rules/efbfc7/proposed/)
