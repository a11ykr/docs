...
![단일 간격 텍스트의 예. (텍스트의 각 줄 사이에 공백이 없음)](/docs/img/single-space.gif) ![절반 간격(space-and-a-half) 텍스트의 예.(텍스트 줄 높이의 절반에 해당하는 공백)](/docs/img/space-and-a-half.gif) ![이중 간격 텍스트의 예. (각 줄 사이의 텍스트 줄 높이와 동일한 공백)](/docs/img/double-space.gif)
