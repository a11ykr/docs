...
![단일 간격 텍스트의 예. (텍스트의 각 줄 사이에 공백이 없음)](/assets/img/single-space.gif) ![절반 간격(space-and-a-half) 텍스트의 예.(텍스트 줄 높이의 절반에 해당하는 공백)](/assets/img/space-and-a-half.gif) ![이중 간격 텍스트의 예. (각 줄 사이의 텍스트 줄 높이와 동일한 공백)](/assets/img/double-space.gif)
