---
title: 성공 기준 1.4.10 재정렬
description: 성공 기준 이해 1.4.10 재정렬
tableOfContents:
    maxHeadingLevel: 4
---
...
## [성공기준 이해 1.4.10](https://w3.org/TR/WCAG22#reflow):재정렬 
...
![작은 화면 장치는 가까이 있고, 큰 화면 장치는 멀리 있을 때 망막에 동일한 이미지를 만들기 위해 보는 거리에 따라 필요한 문자 크기를 보여주는 다이어그램](/docs/assets/img/css-pixel-by-device.png)

그림 1 해상도가 다른 여러 디스플레이에서 동일한 CSS 픽셀 크기의 문자
